  ...
  <div>
    <section class="py-32 px-4 md:px-8">
      <div class="max-w-4xl mx-auto text-center">
        <h2 class="font-newsreader italic text-white-shadow text-center text-4xl">Mari Berkolaborasi</h2>
        <p class="text-lg text-gray-600 mb-12">
          Tertarik untuk bekerja sama? Jangan ragu untuk menghubungi saya.
        </p>
        <div class="flex justify-center space-x-6">
          <NuxtLink to="mailto:edoaurahman@gmail.com" class="text-gray-600 hover:text-indigo-600 transition duration-300">
          ...
          <NuxtLink to="https://www.linkedin.com/in/ridho-aulia-rahman-767994206/" target="_blank" class="text-gray-600 hover:text-indigo-600 transition duration-300">
          ...
          <NuxtLink to="https://github.com/edoaurahman" target="_blank" class="text-gray-600 hover:text-indigo-600 transition duration-300">
